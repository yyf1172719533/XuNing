...
import com.timain.common.annotation.DataSource;
...
public class DataSourceAspect {
    ...
    @Pointcut("@annotation(com.timain.common.annotation.DataSource) || @within(com.timain.common.annotation.DataSource)")
